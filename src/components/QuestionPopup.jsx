...
function QuestionPopup({ allQuestions, setShowquestion, user, setValiduser }) {
  ...
  const updatePlayerInfoOnCorrectAnswer = ()=>{
    ...
    console.log("New correct: ", newCorrectAnswers);
...
//   useEffect(()=>{
//     console.log("the question", randomQuestion);
...
//         <div className='question-popup-top'>
//           <div className='question-popup-info-btn-div'>
//             <button className='question-popup-info-btn'>i</button>
//           </div>
//           <div className='question-popup-close-btn-div'>
//             <button className='question-popup-close-btn' onClick={closeQuestionPopup}>X</button>
//           </div>
...
//           <div className='question-popup-question-div'>
//             <p>Question: </p>
//             <input type="text" className='question-input-ele' value={randomQuestion.query}  readOnly style={{userSelect:"none", pointerEvents: "none"}}/>
//           </div>
...
//           <button className='question-popup-verify-btn'>Verify</button>
